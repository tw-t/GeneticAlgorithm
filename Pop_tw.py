...
class Population:
    ...
    def showBest(self):
        ...
        print("generations="+str(g.generation)+"  mutations="+str(g.mutations)) # prints global gen and mut count (mutation count only have global count, gen have individual count)
